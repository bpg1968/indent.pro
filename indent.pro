...
// --case-indentationn // Case label indent of n spaces.

// --struct-brace-indentationn // Indent braces of a struct, union or enum N spaces.

// --brace-indentn // Indent braces n spaces.
// --continuation-indentationn // Continuation indent of n spaces.
 ...
 * INDENTATION
 */
// --indent-leveln // Set indentation level to n spaces.
 ...
 * BREAKING LONG LINES
 */
// --line-lengthn // Set maximum line length for non-comment lines to n.
